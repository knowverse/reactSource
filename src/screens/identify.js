...
const Identify = (prop) => {
    ...
    return (
        ...
        <>
            ...
            <h3 className="text-center text-uppercase mt-3">Identify Credentials</h3>

              
                <InputGroup size="md" className="group mb-3 mt-3 col-md-8 m-auto">
                    <InputGroup.Text  className="grouptext"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-person-rolodex" viewBox="0 0 16 16">
