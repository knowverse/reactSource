...
const Update = (prop) => {
    const datafill=(e)=>{
        ...
        prop.data({
            ...
            class:document.forms[0][1].value,
            branch:document.forms[0][2].value,
            section:document.forms[0][3].value
        })
               ...
               {heading}
                ...
                <InputGroup size="md" className="group mb-3 mt-3 col-md-8 m-auto">
                    ...
                    <FloatingLabel controlId="floatingInput" label="Username">
                        <Form.Control required type="text" name="username" placeholder="name@example.com" />
                    </FloatingLabel>
